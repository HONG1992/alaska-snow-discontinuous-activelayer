#Snow Duration and Discontinuous Active Layer Depth Processing
...
for (i in 1:length(fileNames))
{
  ...
  if (file.exists(savedFile)){
    ...
    #akProj <-projection(crs(AK_snow_depth))
    AK_proj <- spTransform(AK, projection(AK_raster_stack))
    #AKInd <- !is.na(over(AKsnow,as(crs(AK_snow_depth), "CRS")))
...
var <- 25
ALDataFrame = data.frame("SiteCode"=rep(0, var),"SiteName"=rep(0, var),"Latitude"=rep(0, var),"Longitude"=rep(0, var),
                         "1990"=rep(0, var),"1991"=rep(0, var),"1992"=rep(0, var),"1993"=rep(0, var),"1994"=rep(0, var),
                         "1995"=rep(0, var),"1996"=rep(0, var),"1997"=rep(0, var),"1998"=rep(0, var),"1999"=rep(0, var),
                         "2000"=rep(0, var),"2001"=rep(0, var), "2002"=rep(0,var), "2003"=rep(0,var), "2004"=rep(0,var),
                         "2005"=rep(0,var), "2006"=rep(0,var), "2007"=rep(0,var), "2008"=rep(0,var), "2009"=rep(0,var),
                         "2010"=rep(0,var),"2011"=rep(0,var), "2012"=rep(0,var), "2013"=rep(0,var), "2014"=rep(0,var),
...
# if (activeAK@data[activeAKInd,7:33]%%1 != 0){
#   activeAK@data[activeAKInd,7:33] = NA
# }
...
fsSnowAtLoc = data.frame("2001"=rep(0, var), "2002"=rep(0,var), "2003"=rep(0,var), "2004"=rep(0,var),
                         "2005"=rep(0,var), "2006"=rep(0,var), "2007"=rep(0,var), "2008"=rep(0,var),
                         "2009"=rep(0,var), "2010"=rep(0,var), "2011"=rep(0,var), "2012"=rep(0,var),
                         "2013"=rep(0,var),"2014"=rep(0,var), "2015"=rep(0,var), "2016"=rep(0,var));
...
lsSnowAtLoc = data.frame("2001"=rep(0, var), "2002"=rep(0,var), "2003"=rep(0,var), "2004"=rep(0,var),
                         "2005"=rep(0,var), "2006"=rep(0,var), "2007"=rep(0,var), "2008"=rep(0,var),
                         "2009"=rep(0,var), "2010"=rep(0,var), "2011"=rep(0,var), "2012"=rep(0,var),
                         "2013"=rep(0,var),"2014"=rep(0,var), "2015"=rep(0,var), "2016"=rep(0,var));
...
fsSnowContAtLoc = data.frame("2001"=rep(0, var), "2002"=rep(0,var), "2003"=rep(0,var), "2004"=rep(0,var),
                             "2005"=rep(0,var), "2006"=rep(0,var), "2007"=rep(0,var), "2008"=rep(0,var),
                             "2009"=rep(0,var), "2010"=rep(0,var), "2011"=rep(0,var), "2012"=rep(0,var),
                             "2013"=rep(0,var),"2014"=rep(0,var), "2015"=rep(0,var), "2016"=rep(0,var));
...
lsSnowContAtLoc = data.frame("2001"=rep(0, var), "2002"=rep(0,var), "2003"=rep(0,var), "2004"=rep(0,var),
                             "2005"=rep(0,var), "2006"=rep(0,var), "2007"=rep(0,var), "2008"=rep(0,var),
                             "2009"=rep(0,var), "2010"=rep(0,var), "2011"=rep(0,var), "2012"=rep(0,var),
                             "2013"=rep(0,var),"2014"=rep(0,var), "2015"=rep(0,var), "2016"=rep(0,var));
...
durContSnowPer = data.frame("2001"=rep(0, var), "2002"=rep(0,var), "2003"=rep(0,var), "2004"=rep(0,var),
                            "2005"=rep(0,var), "2006"=rep(0,var), "2007"=rep(0,var), "2008"=rep(0,var),
                            "2009"=rep(0,var), "2010"=rep(0,var), "2011"=rep(0,var), "2012"=rep(0,var),
                            "2013"=rep(0,var),"2014"=rep(0,var), "2015"=rep(0,var), "2016"=rep(0,var));
...
numSDAtLoc = data.frame("2001"=rep(0, var), "2002"=rep(0,var), "2003"=rep(0,var), "2004"=rep(0,var),
                        "2005"=rep(0,var), "2006"=rep(0,var), "2007"=rep(0,var), "2008"=rep(0,var),
                        "2009"=rep(0,var), "2010"=rep(0,var), "2011"=rep(0,var), "2012"=rep(0,var),
                        "2013"=rep(0,var),"2014"=rep(0,var), "2015"=rep(0,var), "2016"=rep(0,var),"SiteName"=rep(0, var));
...
totNumDaysCSSAtLoc = data.frame("2001"=rep(0, var), "2002"=rep(0,var), "2003"=rep(0,var), "2004"=rep(0,var),
                                "2005"=rep(0,var), "2006"=rep(0,var), "2007"=rep(0,var), "2008"=rep(0,var),
                                "2009"=rep(0,var), "2010"=rep(0,var), "2011"=rep(0,var), "2012"=rep(0,var),
                                "2013"=rep(0,var),"2014"=rep(0,var), "2015"=rep(0,var), "2016"=rep(0,var),"SiteName"=rep(0, var));
...
FULLSnowFreeSY = data.frame("2001"=rep(0, var), "2002"=rep(0,var), "2003"=rep(0,var), "2004"=rep(0,var),
                            "2005"=rep(0,var), "2006"=rep(0,var), "2007"=rep(0,var), "2008"=rep(0,var),
                            "2009"=rep(0,var), "2010"=rep(0,var), "2011"=rep(0,var), "2012"=rep(0,var),
                            "2013"=rep(0,var),"2014"=rep(0,var), "2015"=rep(0,var), "2016"=rep(0,var));
...
CONTSnowFreeSY = data.frame("2001"=rep(0, var), "2002"=rep(0,var), "2003"=rep(0,var), "2004"=rep(0,var),
                            "2005"=rep(0,var), "2006"=rep(0,var), "2007"=rep(0,var), "2008"=rep(0,var),
                            "2009"=rep(0,var), "2010"=rep(0,var), "2011"=rep(0,var), "2012"=rep(0,var),
                            "2013"=rep(0,var),"2014"=rep(0,var), "2015"=rep(0,var), "2016"=rep(0,var));
...
FULLSnowFreeCY = data.frame("2002"=rep(0,var), "2003"=rep(0,var), "2004"=rep(0,var),
                            "2005"=rep(0,var), "2006"=rep(0,var), "2007"=rep(0,var), "2008"=rep(0,var),
                            "2009"=rep(0,var), "2010"=rep(0,var), "2011"=rep(0,var), "2012"=rep(0,var),
                            "2013"=rep(0,var),"2014"=rep(0,var), "2015"=rep(0,var), "2016"=rep(0,var));
...
CONTSnowFreeCY = data.frame("2002"=rep(0,var), "2003"=rep(0,var), "2004"=rep(0,var),
                            "2005"=rep(0,var), "2006"=rep(0,var), "2007"=rep(0,var), "2008"=rep(0,var),
                            "2009"=rep(0,var), "2010"=rep(0,var), "2011"=rep(0,var), "2012"=rep(0,var),
                            "2013"=rep(0,var),"2014"=rep(0,var), "2015"=rep(0,var), "2016"=rep(0,var));
...
CONTFreezeSY = data.frame("2002"=rep(0,var), "2003"=rep(0,var), "2004"=rep(0,var),
                          "2005"=rep(0,var), "2006"=rep(0,var), "2007"=rep(0,var), "2008"=rep(0,var),
                          "2009"=rep(0,var), "2010"=rep(0,var), "2011"=rep(0,var), "2012"=rep(0,var),
                          "2013"=rep(0,var),"2014"=rep(0,var), "2015"=rep(0,var), "2016"=rep(0,var));
